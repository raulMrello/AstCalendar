 ...
 * activar dicha capacidad mediante AstCalendar::setJSONSupport(true)
 */
TEST_CASE("Set Config Data.......................", "[AstCalendar]"){
	MQ::ErrorResult res;
	double count = 0;
	...
	char* msg = "{\"idTrans\":2,\"keys\":0,\"data\":{\"cfg\":{\"verbosity\":4},\"clock\":{\"cfg\":{\"periods\":[{\"uid\":13,\"since\":10,\"until\":20,\"enabled\":1}],\"geoloc\":{\"coords\":[40.2,-3.2],\"astCorr\":[[0,0]]}}}}}";
	DEBUG_TRACE_I(_EXPR_, _MODULE_, "Request:\r\nto:set/cfg/astcal\r\nmsg:%s", msg);
